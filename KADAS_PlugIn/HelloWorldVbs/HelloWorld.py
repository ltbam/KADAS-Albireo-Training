...
class HelloWorld:
    ...
    def hello_world(self):
        QMessageBox.information(self.iface.mainWindow(), QCoreApplication.translate('HelloWorld', "IKT Fachfuehrung Training Plug-in"), QCoreApplication.translate('HelloWorld', "Gruessech mitenand!"))
        return
